# Henri Lefebvre Logique Formelle et Logique Dialectique : Chapitre 3
...
La configuration des idees selon le rapport genre prochain et difference specifique produit un indecidable a chacune des extremites de ce montage organisant nos idees. En effet:

- les individus constituant une comprehension (ensemble des qualites essentiels) infini mais a extension nulle (propre a un seul individu) 
- les genres universaux constituant une extension infini mais a comprehension nulle (contenu virtuellement nulle pour etre applique a tout objet) 
